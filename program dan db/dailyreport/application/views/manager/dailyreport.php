                    ...
                    <table class="table table-striped" id="dataTable" width="100%" cellspacing="0">
                        ...
                        <tbody>
                            ...
                            <tr class="text-center">
                                ...
                                <td class="py-1 align-middle text-center"><?= $dm['tgl_kegiatan']; ?></td>
                                <td class="py-1 align-middle text-center"><?= $dm['nama']; ?></td>
                                <?php if ($dm['status'] == 1) : ?>
    ...
    <div class="modal-dialog modal-md" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="<?= base_url('manager/daily'); ?>" method="post">
                    ...
                    <input type="hidden" name="verifikator" class="form-control" id="exampleInputEmail"
                        value="<?= $user['nama']; ?>">
